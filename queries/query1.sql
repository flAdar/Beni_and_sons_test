...
recruiter_id,
applicant_amount,
100*SUM(recruitment_amount)/SUM(applicant_amount) OVER (PARTITION BY recruiter_id, recruitment_month, application_month) AS percentage,
SUM(bonus) OVER (PARTITION BY recruiter_id, recruitment_month) AS bonus_amount
